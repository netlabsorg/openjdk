...
# NOTE: This file is a copy of linux_x86_32.s with unnecessary
# functions thrown away and underscores added
	

        # NOTE WELL!  The __Copy functions are called directly
	# from server-compiler-generated code via CallLeafNoFP,
	# which means that they *must* either not use floating
	# point or use it in the same manner as does the server
	# compiler.
	
        .globl __Copy_conjoint_bytes
        .globl __Copy_arrayof_conjoint_bytes
        .globl __Copy_conjoint_jshorts_atomic
	.globl __Copy_arrayof_conjoint_jshorts
        .globl __Copy_conjoint_jints_atomic
        .globl __Copy_arrayof_conjoint_jints
	.globl __Copy_conjoint_jlongs_atomic
	.globl __mmx_Copy_arrayof_conjoint_jshorts

        .globl __Atomic_cmpxchg_long
        .globl __Atomic_move_long
	...
	.text
        ...
        #                                       size_t count)
        .p2align 4,,15
	.type    __Copy_conjoint_bytes,@function
__Copy_conjoint_bytes:
        pushl    %esi
...
7:      cld
        ...
        #                                               size_t count)
        #
        # Same as __Copy_conjoint_bytes, except no source alignment check.
        .p2align 4,,15
	.type    __Copy_arrayof_conjoint_bytes,@function
...
7:      cld
        ...
        #                                                size_t count)
        .p2align 4,,15
	.type    __Copy_conjoint_jshorts_atomic,@function
__Copy_conjoint_jshorts_atomic:
        pushl    %esi
        movl     4+12(%esp),%ecx      # count
        pushl    %edi
        movl     8+ 4(%esp),%esi      # from
...
5:      cld
        ...
        #                                                 size_t count)
        .p2align 4,,15
	.type    __Copy_arrayof_conjoint_jshorts,@function
__Copy_arrayof_conjoint_jshorts:
        pushl    %esi
        movl     4+12(%esp),%ecx      # count
        pushl    %edi
        movl     8+ 4(%esp),%esi      # from
...
5:      cld
        ...
        .p2align 4,,15
	.type    __Copy_conjoint_jints_atomic,@function
	.type    __Copy_arrayof_conjoint_jints,@function
__Copy_conjoint_jints_atomic:
__Copy_arrayof_conjoint_jints:
        pushl    %esi
        movl     4+12(%esp),%ecx      # count
        pushl    %edi
        movl     8+ 4(%esp),%esi      # from
...
4:      movl     %eax,%esi            # from + count*4 - 4
        ...
        # }
        .p2align 4,,15
	.type    __Copy_conjoint_jlongs_atomic,@function
__Copy_conjoint_jlongs_atomic:
...
cla_CopyLeft:
        ...
        #                                                 size_t count)
        .p2align 4,,15
	.type    __mmx_Copy_arrayof_conjoint_jshorts,@function
__mmx_Copy_arrayof_conjoint_jshorts:
        pushl    %esi
        movl     4+12(%esp),%ecx
        pushl    %edi
        movl     8+ 4(%esp),%esi
...
6:      cld
        ...
        #
        .p2align 4,,15
	.type    __Atomic_cmpxchg_long,@function
__Atomic_cmpxchg_long:
                                   #  8(%esp) : return PC
...
1:      cmpxchg8b (%edi)
        ...
        .p2align 4,,15
	.type    __Atomic_move_long,@function
__Atomic_move_long:
        movl     4(%esp), %eax   # src
        fildll    (%eax)
        movl     8(%esp), %eax   # dest
